...
def get_config(args):
    ...
    cfg.additem(key='ttl', section='main', defined=True, type='uint', replace=args.ttl)
    cfg.additem(key='tws', section='main', defined=True, type='uint', replace=args.tws)
    cfg.additem(key='twf', section='main', defined=True, type='uint', replace=args.twf)
    cfg.additem(key='tlast', section='main', defined=True, type='uint', replace=args.tlast)
    cfg.additem(key='sid', section='main', defined=True, type='text', replace=args.sid)
    cfg.additem(key='query', section='main', defined=True, type='text', replace=args.query)
    cfg.additem(key='output', section='main', defined=True, type='text', replace=args.output)
